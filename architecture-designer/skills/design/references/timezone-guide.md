...
|--------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Node.js                  | Native `Temporal` (Stage 4 as of 2026 — verify it's shipped, unflagged, in the target runtime version) or `date-fns-tz` / `Luxon` for older runtimes | `node-cron`/`node-schedule` with an explicit IANA `timezone` option, or a managed scheduler (e.g. cloud provider's cron with timezone support) — never a bare UTC cron expression for a local-time job |
