...
| Any other named external service (Stage 5 §6)       | a matching vendor MCP, if one is connected                          | Whatever that MCP's own tools cover for provisioning or querying that service                 |
