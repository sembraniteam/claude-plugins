...
python3 $CLAUDE_PLUGIN_ROOT/scripts/generate-release-notes.py \
  --platform playstore \
  --lang en_US \
    --summary "We've packed this update with features you've been asking for, plus important fixes to make your experience smoother and more reliable every day." \
  ...
  --lang id_ID \
    --summary "Pembaruan ini hadir dengan fitur-fitur yang kalian minta dan perbaikan penting untuk pengalaman yang lebih lancar setiap harinya." \
...
- Summary EN_US: 144 chars (above 100-char minimum)
- Summary ID_ID: 131 chars (above 100-char minimum)
