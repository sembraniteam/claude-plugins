...
│   │   │   └── references/
│   │   │       ├── session-schema.md              # session.json schema, single-writer rule, resumable/orphaned-plan detection
│   │   │       ├── diagrams-guide.md              # Mermaid templates, anti-overlap rules (ELK, align), CI/CD pipeline template
│   │   │       ├── document-template.md           # 18-section document body template + conditional/required sections
│   │   │       ├── document-review-checklist.md   # F1–F7 / C1–C19 document review item catalog
│   │   │       ├── remediation-plan-guide.md      # Remediation plan markdown format and checkbox/suffix conventions
│   │   │       ├── discovery-questions.md         # Stage 1–4 requirements-gathering question banks
│   │   │       ├── domain-edge-cases-guide.md     # Domain edge-case elicitation catalog (auth, payments, scheduling, etc.)
...
│   │   │       ├── test-strategy-guide.md         # Test pyramid, load/perf targets, chaos scenarios, security checklist, UAT
│   │   │       ├── adr-guide.md                   # Architecture Decision Record template, naming/numbering, supersede procedure
│   │   │       ├── design-principles-guide.md     # SOLID, DRY, YAGNI, Tell Don't Ask, Hollywood Principle/IoC, Law of Demeter
│   │   │       ├── design-patterns-guide.md       # GoF design patterns (all 23) and POSA architectural patterns
│   │   │       ├── clean-code-guide.md            # Naming, small functions, error handling, FIRST/AAA testable-code practices
│   │   │       ├── transaction-guide.md           # ACID, isolation levels, optimistic/pessimistic concurrency control, Saga
│   │   │       ├── web3-guide.md                  # Optional Web3/decentralized track — network-agnostic dimension questions
│   │   │       ├── offline-first-guide.md         # Optional offline-first track — local storage, outbox sync, conflict resolution
│   │   │       ├── scaffolding-guide.md           # Official generator CLI per stack, preferred over hand-authored boilerplate
│   │   │       ├── rate-limiting-guide.md         # Rate-limiting algorithm/library tradeoffs and enforcement layer
│   │   │       ├── resilience-guide.md            # Retry/circuit-breaker/timeout/graceful-degradation pattern tradeoffs
│   │   │       └── timezone-guide.md              # UTC-at-rest storage policy, DST-safe scheduling, per-stack library
│   │   ├── review/
...
│   ├── hooks/
│   │   ├── hooks.json                        # 7 hooks: SessionStart, UserPromptSubmit, PreToolUse (x2), PostToolUse, SubagentStop, PreCompact
...
│   │   ├── check-deploy-command.sh           # PreToolUse (Bash) — blocks a chain deploy/broadcast command while a plan is In progress
