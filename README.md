...
| `document-fixer` agent             | Fixes specific F1–F7 format and C1–C15 content failures in the architecture document based on document-reviewer findings; overwrites the draft in place                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
│   │   ├── document-fixer.md           # Fixes F1–F7 format and C1–C15 content failures in place
...
│   │   │       ├── document-template.md           # 10-section document body template + conditional/required sections
│   │   │       ├── document-review-checklist.md   # F1–F7 / C1–C15 document review item catalog
